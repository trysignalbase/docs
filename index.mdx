...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="radar"
    href="/api-reference/monitors/introduction"
  >
    Watch your own list of companies and get their signals pushed to you as they happen.
  </Card>
  <Card
    title="Webhooks"
    icon="webhook"
  ...
  >
    Receive signed, real-time signal deliveries on your own HTTPS endpoint.
  </Card>
</CardGroup>
